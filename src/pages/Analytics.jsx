      ...
      <div className="wrapper max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="curvebgdesign relative w-full backdrop-blur-10xl backdrop-brightness-10 rounded-[20px] rounded-tl-[0] overflow-hidden bg-no-repeat bg-[var(--color-bg-glass)]">
          ...
          <div className="space-y-12 px-8 pb-10">
            ...
            >
              <h2 className="font-(family-name:--secondary-font) text-[45px] max-[600px]:text-[30px] font-semibold text-[var(--color-primary)]">Empowering Organizations Through Data</h2>
        ...
        <div className="curvebgdesign relative w-full backdrop-blur-10xl backdrop-brightness-10 rounded-[20px] rounded-tl-[0] overflow-hidden bg-no-repeat bg-[var(--color-bg-glass)] mt-10">
          ...
          <div className="space-y-12 px-8 pb-10">
            <Motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <h2 className="font-(family-name:--secondary-font) text-[45px] max-[600px]:text-[30px] font-semibold text-[var(--color-primary)]">Data Science Services</h2>
        ...
        <div className="curvebgdesign relative w-full backdrop-blur-10xl backdrop-brightness-10 rounded-[20px] rounded-tl-[0] overflow-hidden bg-no-repeat bg-[var(--color-bg-glass)] mt-10">
          ...
          <div className="space-y-12 px-8 pb-10">
            <Motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <h2 className="font-(family-name:--secondary-font) text-[45px] max-[600px]:text-[30px] font-semibold text-[var(--color-primary)]">Delivering Smart Solutions That Work</h2>
        ...
        <div className="curvebgdesign relative w-full backdrop-blur-10xl backdrop-brightness-10 rounded-[20px] rounded-tl-[0] overflow-hidden bg-no-repeat bg-[var(--color-bg-glass)] mt-10">
          ...
          <div className="space-y-12 px-8 pb-10">
            <Motion.div
              ...
              viewport={{ once: true, amount: 0.3 }}
            >
              <h2 className="font-(family-name:--secondary-font) text-[45px] max-[600px]:text-[30px] font-semibold text-[var(--color-primary)]">Our Team Works with Passion</h2>
