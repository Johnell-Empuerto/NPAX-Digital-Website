    ...
    <div className='contact overflow-hidden py-10 bg-[#000]'>
      <div className="wrapper max-w-7xl mx-auto px-4">
        <div className="curvebgdesign relative w-full backdrop-blur-10xl backdrop-brightness-10 rounded-[20px] shadow-lg overflow-hidden bg-no-repeat bg-white/10">
          ...
          {/* Folder Tab Design - Adapted for Contact */}
          ...
          {/* Contact Grid - Enhanced with inner padding, rounded corners on children */}
          <Motion.div 
            className="contact-con grid lg:grid-cols-2 grid-cols-1 gap-0 px-8 pb-10" // gap-0 for seamless split
            ...
            >
              ...
              <div className="absolute bottom-0 w-full p-5 lg:p-11">
                <div className="bg-white rounded-lg p-6 shadow-md">
                  <a href="tel:+1234567890" className="flex items-center mb-6 hover:opacity-80 transition-opacity">
                  ...
                  <a href="mailto:info@example.com" className="flex items-center mb-6 hover:opacity-80 transition-opacity">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
